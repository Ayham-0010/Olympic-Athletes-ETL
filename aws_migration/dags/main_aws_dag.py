...
with DAG(
    ...
    athlete_scrape_glue_job = DockerOperator(
        ...
        command=[
            ...
            "/home/hadoop/workspace/src/athlete_scrape_glue.py",
    ...
    data_clean_II_glue_job = DockerOperator(
        task_id="data_clean_II_glue_job",
        image="aws-glue-5-extended:1.0", # public.ecr.aws/glue/aws-glue-libs:5
        command=[
            "spark-submit",
            "--conf", "spark.hadoop.fs.s3a.endpoint=http://localstack:4566",
            "--conf", "spark.hadoop.fs.s3a.path.style.access=true",
            "/home/hadoop/workspace/src/data_clean_II_glue.py",
            "--JOB_NAME", "data_clean_II"
        ],
        environment={
            "AWS_ACCESS_KEY_ID": "test",
            "AWS_SECRET_ACCESS_KEY": "test",
    ...
    columns_renaming_reordering_glue_job = DockerOperator(
        task_id="columns_renaming_reordering_glue_job",
        image="aws-glue-5-extended:1.0", # public.ecr.aws/glue/aws-glue-libs:5
        command=[
            "spark-submit",
            "--conf", "spark.hadoop.fs.s3a.endpoint=http://localstack:4566",
            "--conf", "spark.hadoop.fs.s3a.path.style.access=true",
            "/home/hadoop/workspace/src/columns_renaming_reordering_glue.py",
            "--JOB_NAME", "data_clean_II"
        ],
        environment={
            "AWS_ACCESS_KEY_ID": "test",
...
>> data_clean_II_glue_job \
>> columns_renaming_reordering_glue_job